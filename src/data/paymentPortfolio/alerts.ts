...
export const ALERTS = [
    {label:"코디네이터 · EOS",color:"inprog",items:[
      {a:"KafkaCoordinatorTxnAbortRising",d:"· DB 저장과 Kafka 발행을 한 트랜잭션으로 묶는 EOS(Exactly-Once) 커밋이 반복 중단되는 징후\n· 확정 처리가 재시도로 밀리기 시작한 첫 신호\n· 방치 시 실패분이 DLQ까지 유입",m:"커밋 중단이 짧은 간격으로 반복 관측될 때 · 1분 지속"},
