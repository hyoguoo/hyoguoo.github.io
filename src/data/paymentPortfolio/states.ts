...
export const STATES = {
    ...
    IN_PROGRESS:{color:"inprog",terminal:false,meaning:"confirm TX 커밋, paymentKey 기록",entry:"확정 실행",entryRef:"executePayment",polling:"PROCESSING",out:[{to:"DONE",label:"APPROVED (수신)"},{to:"FAILED",label:"FAILED 수신"},{to:"QUARANTINED",label:"불일치 / 격리 (AMOUNT_MISMATCH · QUARANTINED)"}]},
