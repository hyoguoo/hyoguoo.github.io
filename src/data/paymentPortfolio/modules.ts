...
export const LAYER_META = [
    {k:"domain",name:"domain",dep:"의존 없음",desc:"순수 도메인 · 외부 의존성 없이 핵심 비즈니스 규칙과 상태를 정의"},
    {k:"application",name:"application",dep:"→ domain",desc:"use case + 입력/출력 포트 + 보조 서비스. 흐름의 조율을 담당"},
