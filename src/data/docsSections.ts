...
export const docsSections: Record<string, SectionConfig> = {
  java: [
    {
      label: 'JVM',
      slugs: ['jvm', 'jvm-runtime-model', 'jvm-execution-and-optimization', 'jvm-jit', 'class-loader', 'garbage-collection', 'jvm-troubleshooting'],
    },
    {
      label: 'Basic Syntax',
  ...
  'performance-engineering': [
    {
      label: 'Foundations',
      slugs: ['performance-physics', 'testing-types-and-strategy', 'metrics-and-statistics'],
    },
    {
      label: 'Modeling',
      slugs: ['workload-modeling', 'user-journey-design', 'data-parameterization'],
    },
    {
      label: 'Tooling - k6',
  ...
  ddd: [
    {
      ...
      slugs: ['intro-to-ddd', 'ubiquitous-language', 'bounded-context', 'context-mapping'],
    },
    {
  ...
  nodejs: [
    {
      ...
      slugs: ['this-binding', 'execution-context-closure', 'asynchronous-programming'],
    },
    {
